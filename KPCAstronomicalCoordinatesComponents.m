...
{
	NSCAssert((*input).system == KPCAstronomicalCoordinatesSystemEquatorial, @"Wrong system");
	...
	(*output).base.theta = newRA * RAD2HOUR;
	(*output).base.phi = newDec * RAD2DEG;
	(*output).base.units = KPCCoordinatesUnitsHoursAndDegrees;
