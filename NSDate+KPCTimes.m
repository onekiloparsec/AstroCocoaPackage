...
//- (double)localSiderealTimeForEveningSunAltitude:(double)sunAltitude withCoordinates:(STLTerrestrialCoordinates *)coords
//{
//	double jdTwilight = julianDayForDateSunAltitudeCoordinates(self, sunAltitude, coords, YES);
//	return localSiderealTimeForJulianDayLongitude(jdTwilight, [coords longitude]);
//}
//
//- (double)localSiderealTimeForMorningSunAltitude:(double)sunAltitude withCoordinates:(STLTerrestrialCoordinates *)coords
//{
//	double jdTwilight = julianDayForDateSunAltitudeCoordinates(self, sunAltitude, coords, NO);
//	return localSiderealTimeForJulianDayLongitude(jdTwilight, [coords longitude]);
//}
